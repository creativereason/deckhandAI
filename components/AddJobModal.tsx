  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50" onClick={onClose}>
      <div
        ...
        className="bg-card rounded-xl shadow-2xl p-6 w-full max-w-lg space-y-4"
      >
        ...
        {!evaluation && (
          <form onSubmit={submit} className="space-y-3">
            ...
            {pending && (
              <p className="text-xs text-muted-foreground italic">{statusText || "Working…"}</p>
            )}
        ...
        {evaluation && (
          <div className="space-y-3">
            <div className="rounded-lg border border-border p-3 space-y-2 bg-muted/50">
              ...
              {evaluation.notes && (
                <p className="text-xs text-muted-foreground whitespace-pre-wrap">{evaluation.notes}</p>
              )}
