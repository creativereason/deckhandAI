...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      <form onSubmit={submit} className="bg-card rounded-2xl shadow-lg px-8 py-9 w-full max-w-sm space-y-5">
        ...
        <div>
          ...
          <input
            ...
            autoFocus
            required
            className="mt-1 w-full border border-border rounded-lg px-3 py-2 text-sm bg-card dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/30 transition"
            value={password}
      ...
      {showForgot && (
        ...
        >
          <div
            className="bg-card rounded-2xl shadow-2xl p-7 max-w-sm w-full"
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <code className="text-xs bg-muted px-1.5 py-0.5 rounded font-mono">APP_PASSWORD</code>{" "}
              environment variable. To find or reset it:
            </p>
            <ul className="space-y-2.5 text-sm text-gray-600 dark:text-gray-300">
              <li className="flex gap-2.5">
                <span className="text-primary font-bold shrink-0">1.</span>
                <span>Check your <code className="text-xs bg-muted px-1.5 py-0.5 rounded font-mono">.env.local</code> file in the project root.</span>
              </li>
              <li className="flex gap-2.5">
              ...
              <li className="flex gap-2.5">
                ...
                <span>If someone else set up this instance, ask them for the <code className="text-xs bg-muted px-1.5 py-0.5 rounded font-mono">APP_PASSWORD</code> value.</span>
              </li>
            </ul>
